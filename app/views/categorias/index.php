...
<body class="bg-gray-100">
    ...
    <main class="flex-grow flex items-center justify-center p-4 w-full max-w-screen-xl mx-auto">
        <div class="bg-white p-6 rounded shadow-md w-full">
            ...
            <p class="my-4">Administra las categorias.</p>

            <form method="GET" action="<?php echo BASE_URL . '/categorias/create' ?>">
    ...
    <script>
        ...
        let rutaList = '<?php echo BASE_URL . "/categorias/list/" ?>';
        let rutaEdit = ruta = '<?php echo BASE_URL . "/categorias/edit/:id" ?>';
        let rutaDestroy = "<?php echo BASE_URL . '/categorias/destroy/:id' ?>";
